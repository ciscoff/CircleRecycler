...
class CustomFrameLayout @JvmOverloads constructor(
    ...
    private val measureObs = BehaviorSubject.createDefault<String>("measure: $countMeasure")
    private val layoutObs = BehaviorSubject.createDefault<String>("layout: $countLayout")
